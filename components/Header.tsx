...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
      {/* Wrapper to allow top-full positioning from here */}
      <div className="relative">
        ...
        {/* Mobile nav panel (overlay, auto height, starts under header) */}
        {open && (
          <nav className="absolute inset-x-0 top-full z-40 bg-white md:hidden shadow-md">
            <div className="px-4 py-4 flex flex-col gap-2">
              <Link
                href="/en/about"
                className="header-link block px-1 py-2 rounded hover:bg-gray-50"
              ...
              <Link
                href="/en/contact"
                className="header-link btn-primary inline-flex items-center justify-center mt-2"
                onClick={() => setOpen(false)}
              >
                Contact
              </Link>
